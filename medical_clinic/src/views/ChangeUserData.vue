  ...
  <div>
      ...
      <div class='details'>
            <div class='edit_client_data'>
                    ...
                    <br />
                    <button type='submit' @click.prevent="editData()" id='editData'>Editeaza datele personale</button>
                    <button type='submit' @click.prevent="cancelEdit()" id='cancelEdit' v-if='this.edit'>Anuleaza</button>
            ...
            <div class='history'>
                ...
                <br />
                <div>Mai multe detalii: <a href='/my_appointments'>Vizualizare istoric</a></div>
            </div>
      </div>
    ...
    methods: {
        ...
        editData() {
            ...
            if(document.getElementById('editData').innerHTML === 'Editeaza datele personale') {
                ...
                if(isNaN(document.getElementById('yearsOld').value)) {
                    this.message = 'Varsta trebuie sa fie un numar!';
                } else {
                    this.edit = 0;
